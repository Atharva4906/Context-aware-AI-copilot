...
export default function Sidebar() {
  const navItems = [
    ...
    { icon: Compass, label: 'Learning Paths', active: true },
    { icon: BookOpen, label: 'Library', active: false },
    { icon: Activity, label: 'Performance', active: false },
  ];

  return (
    <div className="w-64 glass-panel border-r border-slate-700/50 flex flex-col h-full rounded-r-3xl m-4 mr-0 p-6">
